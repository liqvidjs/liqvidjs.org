...
const { animate } = ractive_player__WEBPACK_IMPORTED_MODULE_1__.Utils.animation, { during, from } = ractive_player__WEBPACK_IMPORTED_MODULE_1__.Utils.authoring;
...
function Intro() {
    ...
    const [color, setColor] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("#F0F0F0");
